...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to plumd "gobject list" output
    ...
    def plumd_serialise(self):
        import plumlib
        return plumlib.SHIM_serialise_for_plumd(self.serialise())
