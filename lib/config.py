...
sentinel_cfg = PlumConfig.tokenize(sentinel_config_file)
sentinel_version = "1.1.0"
min_plumd_proto_version_with_sentinel_ping = 70207


def get_plum_conf():
    home = os.environ.get('HOME')

    plum_conf = os.path.join(home, ".plumcore/plum.conf")
    if sys.platform == 'darwin':
        plum_conf = os.path.join(home, "Library/Application Support/PlumCore/plum.conf")

    plum_conf = sentinel_cfg.get('plum_conf', plum_conf)
